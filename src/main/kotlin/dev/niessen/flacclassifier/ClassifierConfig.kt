...
data class ClassifierConfig(
    ...
    val psychoacousticEnergyCliffDb: Float,
    ...
    val naturalAttenuationCutoffHz: Double,
    ...
    companion object {
        ...
        private fun fromProperties(props: Properties): ClassifierConfig {
            ...
            return ClassifierConfig(
                ...
                psychoacousticEnergyCliffDb = required("spectral.psychoacousticEnergyCliffDb").toFloat(),
                ...
                naturalAttenuationCutoffHz = required("classification.naturalAttenuationCutoffHz").toDouble(),
